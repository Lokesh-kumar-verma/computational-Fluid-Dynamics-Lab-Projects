...
int m=31; int n=21;
   ...
   int i,j;
    ...
    for(i=0; i<m; i++){
            for(j=0; j<n; j++){
                 if (i<=5 && j==0){
                    psi2[i][j]=0.0;      //bottom boundary
                }
                else if (i>=6 && j==0){
                    psi2[i][j]=100.0;    //bottom boundary
                }
                else if (j==(n-1)){
                    psi2[i][j]=0.0;      //top boundary
                }
                else if (i==0){
                    psi2[i][j]=0.0;      //left boundary
                }
                else{
                    psi2[i][j]=0.0;
                }
